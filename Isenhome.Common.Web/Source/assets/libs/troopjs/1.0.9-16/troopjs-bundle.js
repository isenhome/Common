 ...
 */
/*global define:true */
define('troopjs-core/widget/placeholder',[ "jquery", "../component/widget" ], function WidgetPlaceholderModule($, Widget) {
...
/*global define:true */
define('troopjs-jquery/weave',[ "jquery", "troopjs-utils/getargs", "require", "./destroy" ], function WeaveModule($, getargs, parentRequire) {
	var UNDEFINED;
	var FUNCTION = Function;
	var ARRAY_PROTO = Array.prototype;
