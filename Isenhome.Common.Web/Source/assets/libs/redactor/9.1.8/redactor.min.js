	...
	Redactor.fn = $.Redactor.prototype = {
		...
		imageInsert: function(json, link)
		{
			...
			if (json !== false)
			{
				...
				if (link !== true)
				{
					json = this.callback('imageUpload', null, json);
...
RedactorPlugins.fontcolor = {
	init: function()
	{
		...
		for (var i = 0; i < 2; i++)
		{
			...
			this.buttonAddBefore('bold', name, this.opts.curLang[name], $.proxy(function(btnName, $button, btnObject, e)
			{
				this.dropdownShow(e, btnName);
...
RedactorPlugins.fontfamily = {
	init: function ()
	{
		...
		var fonts = [ "宋体", "楷体", "微软雅黑", "Arial", "Comic Sans", "Tohoma", "Times New Roman" ];
		var that = this;
		var dropdown = {};
...
RedactorPlugins.fontsize = {
	init: function()
	{
		...
		this.buttonAddBefore('bold', 'fontsize', 'Change font size', false, dropdown);
	},
